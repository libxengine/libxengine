...
m_EnvAuthBreak=0
m_EnvRelease=0
m_EnvRunRPM='redhat-lsb libuuid libpcap openssl-libs libcurl mariadb-connector-c zlib minizip ffmpeg-libs jsoncpp lksctp-tools bluez-libs lirc-libs SDL2 net-snmp-libs mongo-c-driver-libs libpq libsqlite3x'
...
function InstallEnv_Print()
{
	...
	echo -e "\033[33m                       脚本版本：Ver 7.0.0.1001                              \033[0m"
	echo -e "\033[32m|***************************************************************************|\033[0m"
