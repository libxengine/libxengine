...
#define ERROR_XCORE_NETXAPI_SNIFFER_START_SOCKET 0x10C1003              //打开句柄失败
#define ERROR_XCORE_NETXAPI_SNIFFER_START_BIND 0x10C1004                //绑定端口失败
#define ERROR_XCORE_NETXAPI_SNIFFER_START_IOCTL 0x10C1005               //IOCTL错误
#define ERROR_XCORE_NETXAPI_SNIFFER_START_THREAD 0x10C1006              //启动线程失败
...
#define ERROR_XCORE_NETXAPI_FLOW_NET_GETFLOW_MALLOC 0x10C2005           //申请内存失败
//流量控制错误
