...
//传递0将不获取或者设置，如果是XBOOL型，因为是指针所以传递NULL 将不获取。
typedef struct tag_XEngine_ManagePool_SocketOpt
{
    XBOOL* pbDelay;                                                        //是否开启沾包处理,只支持TCP
    XBOOL* pbKeepLive;                                                     //是否开启保活计时器，不支持ATM
    XBOOL* pbReuseAddr;                                                    //是否允许地址重用
    XBOOL* pbSndLinger;                                                    //如果设置为真，那么将会阻塞close并且不会让发送缓冲区完成发送
    XBOOL* pbRcvLinger;                                                    //关闭延迟接受，目前不支持此参数设置
...
备注：
*********************************************************************/
extern "C" XBOOL ManagePool_Thread_DTDestroy(XHANDLE xhPool);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ManagePool_Thread_DTPostTask(XHANDLE xhPool, MANAGEPOOL_THREAD_WORKERPROC fpCall_ThreadsTask, XPVOID lParam = NULL, XNETHANDLE xhToken = 0, XNETHANDLE xhSerial = 0);
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL ManagePool_Thread_DTAddBreakTaskEx(XHANDLE xhPool, XNETHANDLE xhToken, XNETHANDLE xhStart = 0, XNETHANDLE xhStop = 0);
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL ManagePool_Thread_DTDelBreakTaskEx(XHANDLE xhPool, XNETHANDLE xhToken);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ManagePool_Thread_DTGetThreadStateEx(XHANDLE xhPool, LPTHREADPOOL_STATECOUNT pSt_ThreadState);
/********************************************************************
...
备注：会根据值自动增加和减少
*********************************************************************/
extern "C" XBOOL ManagePool_Thread_DTSetThreadEx(XHANDLE xhPool, int nThreadCount);
//////////////////////////////////////////////////////////////////////////无队列线程池
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL ManagePool_Thread_NQDestroy(XHANDLE xhPool);
//////////////////////////////////////////////////////////////////////////竞争模式
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ManagePool_Thread_CTPostTask(MANAGEPOOL_THREAD_WORKERPROC fpCall_ThreadsTask, XPVOID lParam = NULL);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ManagePool_Thread_CTDestroy();
/************************************************************************/
/*                      连接池                                          */
/************************************************************************/
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL ManagePool_Socket_Create(XNETHANDLE * pxhPool, XLONG dwSocketNumber, XLONG dwSocket = XENGINE_MANAGEPOOL_SOCKET_IN_TYPE_TCPV4);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ManagePool_Socket_GetIdleSocket(XNETHANDLE xhPool, XSOCKET * phSocket);
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL ManagePool_Socket_RetIdleSocket(XNETHANDLE xhPool, XSOCKET hSocket);
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL ManagePool_Socket_SetSize(XNETHANDLE xhPool, XUINT unPoolSize, XLONG dwSocket = 0);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ManagePool_Socket_Opt_Get(XSOCKET hSocket, LPXENGINE_MANAGEPOOL_SOCKETOPT pSt_ManagePool_SocketOpt);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ManagePool_Socket_Opt_Set(XSOCKET hSocket, LPXENGINE_MANAGEPOOL_SOCKETOPT pSt_ManagePool_SocketOpt);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ManagePool_Socket_Destroy(XNETHANDLE xhPool);
/************************************************************************/
/*                      内存池                                          */
/************************************************************************/
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ManagePool_Memory_CleanupAdd(XHANDLE pxmPool, CALLBACK_MANAGEPOOL_MEMORY_CLEANUP_HANDLE fpCall_Cleanup, XPVOID lParam = NULL);
