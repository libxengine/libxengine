...
#define ERROR_XCORE_PROTOCOL_ICMP_PING_RECV 0x10E0003                     //接受数据失败
/************************************************************************/
/*                  TRACER路由路径过程                                  */
/************************************************************************/
#define ERROR_XCORE_PROTOCOL_TRACE_TRACE_PARAMENT 0x10E1001               //参数错误
#define ERROR_XCORE_PROTOCOL_TRACE_SEND 0x10E1002                         //发送数据失败
#define ERROR_XCORE_PROTOCOL_TRACE_RECV 0x10E1003                         //超时
//////////////////////////////////////////////////////////////////////////
//                         原始套接字错误表
//////////////////////////////////////////////////////////////////////////
