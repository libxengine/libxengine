...
#define ERROR_XCORE_MANAGEPOOL_SOCKET_OPT_SET_HIGH_PARAMENTISNULL 0x20B0061    //参数全是XNULL
...
#define ERROR_XCORE_MANAGEPOOL_SOCKET_OPT_GET_HIGH_PARAMENTISNULL 0x20B0091    //参数错误，全为XNULL。没有任何意义
...
#define ERROR_XCORE_MANAGEPOOL_SOCKET_OPT_GET_STRUCTPOINT 0x20B00B1            //获取失败，参数结构体指针为XNULL
#define ERROR_XCORE_MANAGEPOOL_SOCKET_OPT_GET_BUFSIZE_SOCKETISFAILED 0x20B00C0 //获取缓冲区大小失败，套接字错误
#define ERROR_XCORE_MANAGEPOOL_SOCKET_OPT_GET_BUFSIZE_PARAMENT 0x20B00C1       //获取失败，参数全为XNULL
...
#define ERROR_XCORE_MANAGEPOOL_THREAD_POSTWORK_PARAMENT 0x20B1011              //参数错误，无法继续，为XNULL
...
#define ERROR_XCORE_MANAGEPOOL_THREAD_GET_PARAMENT 0x20B1040                   //获取失败，参数为XNULL
