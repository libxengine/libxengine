...
#define ERROR_XCORE_SOCKET_TCP_XCORE_POSTMSG_MODEVENT 0x10A4322               //修改事件失败
...
#define ERROR_XCORE_SOCKET_UDP_XCORE_POSTMSG_PARAMENT 0x10A4540               //参数错误，投递失败
#define ERROR_XCORE_SOCKET_UDP_XCORE_POSTMSG_MODEVENT 0x10A4541               //修改事件失败
#define ERROR_XCORE_SOCKET_UDP_XCORE_POSTMSG_MALLOC 0x10A4542                 //申请内存失败
#define ERROR_XCORE_SOCKET_UDP_XCORE_POSTMSG_ISFAILED 0x10A4543               //投递消息失败,内部错误
