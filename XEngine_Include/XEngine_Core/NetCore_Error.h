...
#define ERROR_XCORE_SOCKET_TCP_XCORE_SETSIGN 0x20A4302                   //设置信号失败
#define ERROR_XCORE_SOCKET_TCP_XCORE_CREATETHREAD 0x20A4303              //启动线程失败
#define ERROR_XCORE_SOCKET_TCP_XCORE_MALLOC 0x20A4304                    //申请内存失败
#define ERROR_XCORE_SOCKET_TCP_XCORE_EPOLL 0x20A4305                     //创建数据传输EPOLL失败
#define ERROR_XCORE_SOCKET_TCP_XCORE_ADD 0x20A4306                       //添加事件失败
#define ERROR_XCORE_SOCKET_TCP_XCORE_CREATEIO 0x20A4307                  //创建IO失败
#define ERROR_XCORE_SOCKET_TCP_XCORE_PIP 0x20A4308                       //创建管道失败
#define ERROR_XCORE_SOCKET_TCP_XCORE_PARAMENT 0x20A4309                  //投递数据失败，参数错误
#define ERROR_XCORE_SOCKET_TCP_XCORE_NOTFOUND 0x20A4310                  //没有找到客户端
#define ERROR_XCORE_SOCKET_TCP_XCORE_NOTSUPPORT 0x20A4311                //不支持此模式
#define ERROR_XCORE_SOCKET_TCP_XCORE_CTLDEL 0x20A4312                    //删除事件失败
#define ERROR_XCORE_SOCKET_TCP_XCORE_MAXCONN 0x20A4314                   //到达最大连接数
#define ERROR_XCORE_SOCKET_TCP_XCORE_BADSOCKET 0x20A4315                 //客户端套接字有错误，请关闭此客户端
#define ERROR_XCORE_SOCKET_TCP_XCORE_BREAK 0x20A4316                     //此客户端被设置为跳过数据处理
#define ERROR_XCORE_SOCKET_TCP_XCORE_NOTCLIENT 0x20A4317                 //获取失败，没有客户端在线
#define ERROR_XCORE_SOCKET_TCP_XCORE_POSTRECV 0x20A4318                  //投递接受事件失败
#define ERROR_XCORE_SOCKET_TCP_XCORE_POSTSEND 0x20A4319                  //投递发送事件失败
//扩展函数错误
