...
#define ERROR_XCORE_SOCKET_SOCKET_SEND_CLOSE 0x10A4521                 //发送失败,对方关闭连接
#define ERROR_XCORE_SOCKET_SOCKET_SEND_ISFAILED 0x10A4522              //发送失败，内部错误
#define ERROR_XCORE_SOCKET_SOCKET_SEND_TIMEOUT 0x10A4523               //发送失败，超时
...
#define ERROR_XCORE_SOCKET_TCP_XCORE_SENDMSG_PARAMENT 0x10A4391               //投递数据失败，参数错误
#define ERROR_XCORE_SOCKET_TCP_XCORE_SENDMSG_NOTFOUND 0x10A4392               //没有找到指定客户端
#define ERROR_XCORE_SOCKET_TCP_XCORE_SENDMSG_BREAK 0x10A4393                  //此客户端被设置为跳过数据处理
#define ERROR_XCORE_SOCKET_TCP_XCORE_SENDMSG_MALLOC 0x10A4394                 //申请内存失败
#define ERROR_XCORE_SOCKET_TCP_XCORE_SENDMSG_ISFAILED 0x10A4395               //发送失败
#define ERROR_XCORE_SOCKET_TCP_XCORE_SENDMSG_MODEVENT 0x10A4396               //修改事件失败
...
#define ERROR_XCORE_MULTICAST_BROADCAST_SENDTOFAILED 0x10A6106           //发送失败，XSOCKET错误
