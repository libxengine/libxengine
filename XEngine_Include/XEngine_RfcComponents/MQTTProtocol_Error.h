...
#define ERROR_RFCCOMPONENTS_MQTT_PROTOCOL_PARSE_MALLOC 0x70B1005         //申请内存失败
#define ERROR_RFCCOMPONENTS_MQTT_PROTOCOL_PARSE_NOTFOUND 0x70B1006       //没有找到
#define ERROR_RFCCOMPONENTS_MQTT_PROTOCOL_PARSE_EMPTY 0x70B1007          //数据队列为空
#define ERROR_RFCCOMPONENTS_MQTT_PROTOCOL_PARSE_NOTCOMPLETE 0x70B1008    //没有组装完成的包