...
typedef struct
{
    CHAR tszCodecName[64];                                                //编码名册好难过,H264 H265 MPEG4-GENERIC(AAC)
...
typedef struct
{
    ...
    struct
    {
        CHAR tszSPSBase[128];                                             //经过BASE64编码的SPS信息
        CHAR tszPPSBase[128];                                             //经过BASE64编码的PPS信息
        CHAR tszLeaveId[128];                                             //H.264的sps的第1个字节之后的3个字节(不包括第一个字节).如果是H265,表示VPS信息
...
typedef struct
{
    CHAR tszAttrKey[128];                                               //某些情况下可能没有KEY,只有值
    CHAR tszAttrValue[128];
}RFCCOMPONENTS_SDPPROTOCOL_ATTR;
//////////////////////////////////////////////////////////////////////////
//                         导出的函数
//////////////////////////////////////////////////////////////////////////
extern "C" DWORD SDPProtocol_GetLastError(int *pInt_SysError = NULL);
/************************************************************************/
/*                         SDP打包器导出函数                            */
/************************************************************************/
/********************************************************************
...
备注：
*********************************************************************/
extern "C" BOOL RfcComponents_SDPPacket_GetPacket(XNETHANDLE xhToken, CHAR *ptszMsgBuffer, int *pInt_Len);
/********************************************************************
...
备注：此函数必须调用
*********************************************************************/
extern "C" BOOL RfcComponents_SDPPacket_Session(XNETHANDLE xhToken, LPCSTR lpszSessionName, BOOL bVideo = TRUE);
/********************************************************************
...
备注：此函数必须调用
*********************************************************************/
extern "C" BOOL RfcComponents_SDPPacket_KeepTime(XNETHANDLE xhToken, LPCSTR lpszTimeStart = NULL, LPCSTR lpszTimeEnd = NULL);
/********************************************************************
...
备注：可选,可添加多个
*********************************************************************/
extern "C" BOOL RfcComponents_SDPPacket_AddMedia(XNETHANDLE xhToken, LPCSTR lpszAVType, int nCodec);
/********************************************************************
...
备注：此参数只可使用一次
*********************************************************************/
extern "C" BOOL RfcComponents_SDPPacket_OptionalMediaName(XNETHANDLE xhToken, LPCSTR lpszMediaName);
/********************************************************************
...
备注：可选函数,此参数仅允许调用一次
*********************************************************************/
extern "C" BOOL RfcComponents_SDPPacket_OptionalContact(XNETHANDLE xhToken, LPCSTR lpszEmailAddr = NULL, LPCSTR lpszPhoneNumber = NULL);
/********************************************************************
...
备注：可选函数,此参数仅允许调用一次
*********************************************************************/
extern "C" BOOL RfcComponents_SDPPacket_OptionalRange(XNETHANDLE xhToken, LPCSTR lpszTimeStart = NULL, LPCSTR lpszTimeEnd = NULL);
/********************************************************************
...
备注：可选函数,可添加多次
*********************************************************************/
extern "C" BOOL RfcComponents_SDPPacket_OptionalAddAttr(XNETHANDLE xhToken, LPCSTR lpszKey, LPCSTR lpszValue = NULL);
/************************************************************************/
/*                         SDP解析器导出函数                            */
/************************************************************************/
/********************************************************************
...
备注：
*********************************************************************/
extern "C" BOOL RfcComponents_SDPParse_Create(XNETHANDLE *pxhToken, LPCSTR lpszMsgBuffer, int nMsgLen);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" BOOL RfcComponents_SDPParse_GetConnect(XNETHANDLE xhToken, int *pInt_IPVer, CHAR *ptszIPAddr, int *pInt_TTL = NULL, int *pInt_Count = NULL);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" BOOL RfcComponents_SDPParse_GetSession(XNETHANDLE xhToken, CHAR* ptszSessionValue, CHAR* ptszSessionName, BOOL* pbVideo);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" BOOL RfcComponents_SDPParse_OptionalMediaName(XNETHANDLE xhToken, CHAR *ptszMediaName);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" BOOL RfcComponents_SDPParse_OptionalContact(XNETHANDLE xhToken, CHAR *ptszEmailAddr = NULL, CHAR *ptszPhoneNumber = NULL);
/********************************************************************
