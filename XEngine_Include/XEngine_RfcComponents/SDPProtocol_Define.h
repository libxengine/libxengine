...
备注：
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPPacket_Create(XNETHANDLE *pxhToken);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPPacket_Destory(XNETHANDLE xhToken);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPPacket_GetPacket(XNETHANDLE xhToken, XCHAR *ptszMsgBuffer, int *pInt_Len);
/********************************************************************
...
备注：此函数必须调用
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPPacket_Owner(XNETHANDLE xhToken, LPCXSTR lpszUserName, __int64x nSessionID, LPCXSTR lpszAddr, int nIPVer = 2);
/********************************************************************
...
备注：此函数必须调用
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPPacket_KeepTime(XNETHANDLE xhToken, LPCXSTR lpszTimeStart = NULL, LPCXSTR lpszTimeEnd = NULL);
/********************************************************************
...
备注：可选,可添加多个
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPPacket_AddMedia(XNETHANDLE xhToken, LPCXSTR lpszAVType, int nCodec);
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPPacket_AttrAudio(XNETHANDLE xhToken, RFCCOMPONENTS_SDPPROTOCOL_MEDIAAUDIO *pSt_SDPMedia);
/********************************************************************
...
备注：可选,可添加多个,一般的添加完媒体后就需要添加音视频属性,然后在添加媒体在添加属性,这样循环
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPPacket_AttrVideo(XNETHANDLE xhToken, RFCCOMPONENTS_SDPPROTOCOL_MEDIAVIDEO *pSt_SDPMedia);
//////////////////////////////////////////////////////////////////////////以下是可选函数
/********************************************************************
...
备注：此参数只可使用一次
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPPacket_OptionalMediaName(XNETHANDLE xhToken, LPCXSTR lpszMediaName);
/********************************************************************
...
备注：可选函数,此参数仅允许调用一次
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPPacket_OptionalContact(XNETHANDLE xhToken, LPCXSTR lpszEmailAddr = NULL, LPCXSTR lpszPhoneNumber = NULL);
/********************************************************************
...
备注：可选函数,此参数仅允许调用一次
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPPacket_OptionalBandwidth(XNETHANDLE xhToken, int nValue, int nType = 0);
/********************************************************************
...
备注：可选函数,此参数仅允许调用一次
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPPacket_OptionalRange(XNETHANDLE xhToken, LPCXSTR lpszTimeStart = NULL, LPCXSTR lpszTimeEnd = NULL);
/********************************************************************
...
备注：可选函数,可添加多次
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPPacket_OptionalAddAttr(XNETHANDLE xhToken, LPCXSTR lpszKey, LPCXSTR lpszValue = NULL);
/************************************************************************/
/*                         SDP解析器导出函数                            */
/************************************************************************/
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPParse_Create(XNETHANDLE *pxhToken, LPCXSTR lpszMsgBuffer, int nMsgLen);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPParse_Destory(XNETHANDLE xhToken);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPParse_GetVersion(XNETHANDLE xhToken, int *pInt_Version);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPParse_GetOwner(XNETHANDLE xhToken, XCHAR *ptszUserName, __int64x *pInt_SessionID, __int64x *pInt_SessionVer, int *pInt_IPVer, XCHAR *ptszIPAddr);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPParse_GetConnect(XNETHANDLE xhToken, int *pInt_IPVer, XCHAR *ptszIPAddr, int *pInt_TTL = NULL, int *pInt_Count = NULL);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPParse_GetSession(XNETHANDLE xhToken, XCHAR* ptszSessionValue, XCHAR* ptszSessionName, XBOOL* pbVideo);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPParse_GetTime(XNETHANDLE xhToken, __int64x* pInt_TimeStart, __int64x* pInt_TimeEnd);
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPParse_GetMediaVideo(XNETHANDLE xhToken, RFCCOMPONENTS_SDPPROTOCOL_AVVIDEO * **pppSt_ListMedia, int* pInt_ListCount);
/********************************************************************
...
备注：参数二需要调用基础库的BaseLib_OperatorMemory_Free函数进行内存释放
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPParse_GetMediaAudio(XNETHANDLE xhToken, RFCCOMPONENTS_SDPPROTOCOL_AVAUDIO * **pppSt_ListMedia, int* pInt_ListCount);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPParse_OptionalMediaName(XNETHANDLE xhToken, XCHAR *ptszMediaName);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPParse_OptionalContact(XNETHANDLE xhToken, XCHAR *ptszEmailAddr = NULL, XCHAR *ptszPhoneNumber = NULL);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPParse_OptionalBandwidth(XNETHANDLE xhToken, int *pInt_Value, int *pInt_Type);
/********************************************************************
...
备注：参数二需要调用基础库的BaseLib_OperatorMemory_Free函数进行内存释放
*********************************************************************/
extern "C" XBOOL RfcComponents_SDPParse_OptionalAttr(XNETHANDLE xhToken, RFCCOMPONENTS_SDPPROTOCOL_ATTR * **pppSt_ListAttr, int* pInt_ListCount);
