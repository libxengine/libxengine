...
#define ERROR_RFCCOMPONENTS_SIP_PROTOCOL_PARSEPRO_VIANOTIDEL 0x120C00A6   //没有可用的路由信息
/************************************************************************/
/*                     SIP组包器导出错误                                */
/************************************************************************/
...
#define ERROR_RFCCOMPONENTS_SIP_SERVER_FINDADDR_PARAMENT 0xA0B3101        //参数错误
#define ERROR_RFCCOMPONENTS_SIP_SERVER_FINDADDR_NOTFOUND 0xA0B3102        //没有找到指定用户
#define ERROR_RFCCOMPONENTS_SIP_SERVER_USER_PARAMENT 0xA0B3201            //参数错误
/************************************************************************/
/*                     SIP客户端导出错误                                */
/************************************************************************/
