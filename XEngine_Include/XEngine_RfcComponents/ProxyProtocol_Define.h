...
//                         导出的函数
//////////////////////////////////////////////////////////////////////////////////
extern "C" XBOOL ProxyProtocol_GetLastError(int *pInt_SysError = NULL);
/************************************************************************/
/*                     SOCK代理服务器导出函数                           */
/************************************************************************/
//////////////////////////////////////////////////////////////////////////SOCKS服务器
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksCore_Create(LPCXSTR lpszClientID);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksCore_Delete(LPCXSTR lpszClientID);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksCore_SetInfo(LPCXSTR lpszClientID, XPVOID lParam, int nLen);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksCore_GetInfo(LPCXSTR lpszClientID, XPVOID lParam, int* pInt_Len = NULL);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksCore_GetList(XPPPMEM xpppMem, int* pInt_Count, int nSize);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksCore_GetStatus(LPCXSTR lpszClientID, ENUM_RFCCOMPONENTS_PROXY_STATUS* penSocks);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksCore_SetStatus(LPCXSTR lpszClientID, ENUM_RFCCOMPONENTS_PROXY_STATUS enStatus);
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksCore_ParseAuth(LPCXSTR lpszClientID, LPCXSTR lpszMsgBuffer, int nMsgLen, ENUM_RFCCOMPONENTS_PROXYSOCKS_AUTH* penListAuth, int* pInt_Count);
/********************************************************************
...
备注：当状态为ENUM_RFCCOMPONENTS_PROXY_STATUS_AUTH需要做这一步
      如果是匿名登录,需要设置跳过此步骤
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksCore_ParseUser(LPCXSTR lpszClientID, LPCXSTR lpszMsgBuffer, int nMsgLen, ENUM_RFCCOMPONENTS_PROXYSOCKS_AUTH* penAuthType, XCHAR* ptszUser = NULL, XCHAR* ptszPass = NULL);
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksCore_ParseConnect(LPCXSTR lpszClientID, LPCXSTR lpszMsgBuffer, int nMsgLen, ENUM_RFCCOMPONENTS_PROXYSOCKS_COMMAND * penCommand, ENUM_RFCCOMPONENTS_PROXYSOCKS_IPADDR * penIPAddr, XCHAR * ptszClientAddr, int* pInt_Port);
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksCore_HdrPacket(LPCXSTR lpszClientID, XCHAR* ptszMsgBuffer, int* pInt_Len, XBYTE byValue);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksCore_List(XCHAR*** ppptszClientList, int* pInt_ListCount);
//////////////////////////////////////////////////////////////////////////SOCKS客户端
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksClient_AuthPacket(XCHAR* ptszMsgBuffer, int* pInt_Len, ENUM_RFCCOMPONENTS_PROXYSOCKS_AUTH* penAuth, int nCount);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksClient_AuthParse(LPCXSTR lpszMsgBuffer, ENUM_RFCCOMPONENTS_PROXYSOCKS_AUTH * penAuth);
/********************************************************************
...
备注：如果是匿名登录,此步骤忽略
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksClient_LoginPacket(XCHAR* ptszMsgBuffer, int* pInt_Len, LPCXSTR lpszUserName = NULL, LPCXSTR lpszUserPass = NULL);
/********************************************************************
...
备注：登录成功返回真,登录失败返回假
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksClient_LoginParse(LPCXSTR lpszMsgBuffer);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksClient_ConnectPacket(XCHAR* ptszMsgBuffer, int* pInt_Len, LPCXSTR lpszIPAddr, int nPort, ENUM_RFCCOMPONENTS_PROXYSOCKS_COMMAND enCommand = ENUM_RFCCOMPONENTS_PROXYSOCKS_COMMAND_CONNECT, ENUM_RFCCOMPONENTS_PROXYSOCKS_IPADDR enIPAddr = ENUM_RFCCOMPONENTS_PROXYSOCKS_IPADDR_IPV4);
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL ProxyProtocol_SocksClient_ConnectParse(LPCXSTR lpszMsgBuffer, int* pInt_ErrorCode = NULL);
/************************************************************************/
/*                     隧道代理服务                                     */
/************************************************************************/
//////////////////////////////////////////////////////////////////////////隧道代理服务端
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_TunnelCore_Create(LPCXSTR lpszClientID);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_TunnelCore_Delete(LPCXSTR lpszClientID);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_TunnelCore_SetInfo(LPCXSTR lpszClientID, XPVOID lParam, int nLen);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_TunnelCore_GetInfo(LPCXSTR lpszClientID, XPVOID lParam, int* pInt_Len = NULL);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_TunnelCore_GetList(XPPPMEM xpppMem, int* pInt_Count, int nSize);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_TunnelCore_Parse(LPCXSTR lpszClientID, LPCXSTR lpszMsgBuffer, int nMsgLen, XCHAR* ptszIPAddr, int* pInt_Port, XCHAR* ptszUserInfo, XBOOL * pbConnect = NULL);
/********************************************************************
...
备注：xhNet
*********************************************************************/
extern "C" XBOOL ProxyProtocol_TunnelCore_Packet(XCHAR* ptszMsgBuffer, int* pInt_MsgLen, int nHttpCode = 200);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_TunnelCore_List(XCHAR*** ppptszClientList, int* pInt_ListCount);
//////////////////////////////////////////////////////////////////////////隧道代理客户端
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL ProxyProtocol_TunnelClient_Packet(XCHAR* ptszMsgBuffer, int* pInt_MsgLen, LPCXSTR lpszIPAddr, LPCXSTR lpszAuth = NULL, LPCXSTR lpszUserAgent = NULL);