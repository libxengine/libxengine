...
//扩展错误
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_PARAMENT 0x50A2000          //参数错误，启动失败
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_SETSOCKET 0x50A2001         //设置套接字失败
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_CONNECT 0x50A2002           //连接失败
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_MALLOC 0x50A2003
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_BIND 0x50A2004
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_SETSNDOUT 0x50A2005
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_SETRCVOUT 0x50A2006
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_CONNECTISSET 0x50A2007
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_CONNECTTIMEOUT 0x50A2008
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_CONNECTREFUSED 0x50A2009
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_NOTFOUND 0x50A2011       //没有找到客户端
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_ISFAILED 0x50A2012       //内部错误
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_NOTSUP 0x50A2013         //不支持的类型
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_ISCALLBACK 0x50A2014     //回调模式无法继续
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_CLOSE 0x50A2015          //关闭失败
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_NOREADY 0x50A2016        //没有准备好 
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_CREATETHREAD 0x50A2017   //创建线程失败
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_EX_NOTCLIENT 0x50A2018      //没有找到客户端
/************************************************************************/
/*                   网络客户端UDP选择模型套接字错误                         */
/************************************************************************/
...
#define ERROR_XCLIENT_SOCKET_OPT_IOBLOCK_CLOSE 0x50AA020        //关闭套接字
#define ERROR_XCLIENT_SOCKET_OPT_IOBLOCK_TIMEOUT 0x50AA021      //超时
#define ERROR_XCLIENT_SOCKET_OPT_IOBLOCK_ISFAILED 0x50AA022     //发送失败,内部错误
