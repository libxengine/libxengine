...
#define ERROR_XCLIENT_SOCKET_TCPSOCKET_SELECT_RECVPKT_HDR 0x30A1023           //包头大小错误,不支持复杂模式
//扩展错误
...
#define ERROR_XCLIENT_SOCKET_UDPSOCKET_SELECT_RECVPKT_HDR 0x30A3053           //包头大小错误,不支持复杂模式
