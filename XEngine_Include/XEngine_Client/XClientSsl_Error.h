...
#define ERROR_XCLIENT_SSL_CLIENT_SENDMSG_WRITE 0x50B0021         //发送数据失败
#define ERROR_XCLIENT_SSL_CLIENT_SENDMSG_MALLOC 0x50B0022        //申请内存失败
...
#define ERROR_XCLIENT_SSL_CLIENT_RECVMSG_MALLOC 0x50B0034        //申请内存失败
