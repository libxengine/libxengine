...
备注：
*********************************************************************/
extern "C" XBOOL RTPProtocol_Packet_SetInfo(XNETHANDLE xhSsrc, int nSampleSize = 25, int nSampleRate = 90000);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RTPProtocol_Packet_GetRTPTime(XNETHANDLE xhSsrc, unsigned int* pInt_RTPTime);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RTPProtocol_Packet_Destory(XNETHANDLE xhSsrc);
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL RTPProtocol_Packet_Packet(XNETHANDLE xhSsrc, LPCXSTR lpszMsgBuffer, int nMsgLen, STREAMMEDIA_RTPPROTOCOL_PACKET * **pppSt_RTPPacket, int* pInt_PacketCount, XSHOT wProfile = 0, uint32_t * **pppnListExtern = NULL, int nExternCount = 0);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RTPProtocol_Packet_GetCount(XNETHANDLE xhSsrc, unsigned int* pInt_SendPkt, unsigned int* pInt_SendByte, unsigned int* pInt_Time);
/************************************************************************/
/*                      打包函数导出                                    */
/************************************************************************/
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RTPProtocol_Parse_Destory(XNETHANDLE xhToken);
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL RTPProtocol_Parse_Send(XNETHANDLE xhToken, LPCXSTR lpszMsgBuffer, int nMsgLen);
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL RTPProtocol_Parse_Recv(XNETHANDLE xhToken, XCHAR *ptszMsgBuffer, int *pInt_MsgLen, STREAMMEDIA_RTPPROTOCOL_HDR *pSt_RTPHdr, RTPPROTOCOL_RTPEXTERN *pSt_RTPExt = NULL, uint32_t * **pppnListExtern = NULL, int* pInt_ExternCount = NULL);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RTPProtocol_Parse_GetCount(XNETHANDLE xhToken, unsigned int* pInt_PktCount, unsigned int* pInt_ByteCount, unsigned int* pInt_BaseTime);
/************************************************************************/
/*                      帮助函数导出                                    */
/************************************************************************/
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL RTPProtocol_Help_GetRTPTime(unsigned int nTimeBase, unsigned int* pInt_TimeStamp, int nFrameRate = 25, int nSampleRate = 44100);
