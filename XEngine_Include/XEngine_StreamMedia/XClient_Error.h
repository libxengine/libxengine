...
#define ERROR_STREAMMEDIA_XCLIENT_STREAMPUSH_PUSH_SEND 0x140A0022           //发送给编码器失败,不是标准的YUV数据
#define ERROR_STREAMMEDIA_XCLIENT_STREAMPUSH_PUSH_RECV 0x140A0023           //编码器接受数据失败
#define ERROR_STREAMMEDIA_XCLIENT_STREAMPUSH_PUSH_WRITE 0x140A0024          //推送数据给RTMP服务器失败
///裸码流推流
...
#define ERROR_STREAMMEDIA_XCLIENT_STREAMPULL_INIT_MALLOCSTREAM 0x140A2007 //申请流内存失败
#define ERROR_STREAMMEDIA_XCLIENT_STREAMPULL_INIT_NEWSTREAM 0x140A2008    //信件流失败
#define ERROR_STREAMMEDIA_XCLIENT_STREAMPULL_INIT_COPYSTREAM 0x140A2009   //拷贝流失败
#define ERROR_STREAMMEDIA_XCLIENT_STREAMPULL_INIT_WRITEHDR 0x140A2009     //写入头失败
#define ERROR_STREAMMEDIA_XCLIENT_STREAMPULL_INIT_CREATETHREAD 0x140A200A //创建线程失败
#define ERROR_STREAMMEDIA_XCLIENT_STREAMPULL_GETINFO_PARAMENT 0x140A2010  //参数错误
#define ERROR_STREAMMEDIA_XCLIENT_STREAMPULL_GETINFO_NOTFOUND 0x140A2011  //没有找到
