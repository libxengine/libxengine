...
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_ID3V2_PARAMENT 0x40C2040      //获取ID3长度失败,参数错误
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_ID3V2_LEN 0x40C2041           //提供的大小不足够
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_ID3V2_NOHDR 0x40C2042         //没有头,无法继续