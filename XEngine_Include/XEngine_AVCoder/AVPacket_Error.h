...
#define ERROR_XENGINE_AVCODEC_PACKET_FILEUNPACK_OUTPUT_ACREATE 0x40F1121    //创建音频输出流失败
#define ERROR_XENGINE_AVCODEC_PACKET_FILEUNPACK_OUTPUT_AOPEN 0x40F1122      //打开失败
#define ERROR_XENGINE_AVCODEC_PACKET_FILEUNPACK_OUTPUT_AMALLOC 0x40F1123    //申请音频内存失败
#define ERROR_XENGINE_AVCODEC_PACKET_FILEUNPACK_OUTPUT_VCREATE 0x40F1124    //创建视频输出流失败
#define ERROR_XENGINE_AVCODEC_PACKET_FILEUNPACK_OUTPUT_VOPEN 0x40F1125      //打开失败
#define ERROR_XENGINE_AVCODEC_PACKET_FILEUNPACK_OUTPUT_VMALLOC 0x40F1126    //申请视频内存失败
#define ERROR_XENGINE_AVCODEC_PACKET_FILEUNPACK_START_NOTFOUND 0x40F1130    //没有找到
#define ERROR_XENGINE_AVCODEC_PACKET_FILEUNPACK_START_COPYARGS 0x40F1131    //拷贝参数失败
#define ERROR_XENGINE_AVCODEC_PACKET_FILEUNPACK_START_WRITEHDR 0x40F1132    //写入媒体头是失败
#define ERROR_XENGINE_AVCODEC_PACKET_FILEUNPACK_START_THREAD 0x40F1133      //创建线程失败
