...
typedef enum 
{
    ...
    ENUM_XENGINE_AVCODEC_VIDEO_FRAMETYPE_I = 1,                             //I帧
    ENUM_XENGINE_AVCODEC_VIDEO_FRAMETYPE_P = 2,                             //P帧，预测
    ENUM_XENGINE_AVCODEC_VIDEO_FRAMETYPE_B = 3,                             //B帧
    ENUM_XENGINE_AVCODEC_VIDEO_FRAMETYPE_S = 4,
    ENUM_XENGINE_AVCODEC_VIDEO_FRAMETYPE_SI = 5,
    ENUM_XENGINE_AVCODEC_VIDEO_FRAMETYPE_SP = 6,
    ENUM_XENGINE_AVCODEC_VIDEO_FRAMETYPE_BI = 7,
...
typedef enum
{
	...
	ENUM_AVCODEC_VIDEO_SAMPLEFMT_YUV420P = 0,
	ENUM_AVCODEC_VIDEO_SAMPLEFMT_YUYV422 = 1,
	ENUM_AVCODEC_VIDEO_SAMPLEFMT_RGB24 = 2,
	ENUM_AVCODEC_VIDEO_SAMPLEFMT_BGR24 = 3,
	ENUM_AVCODEC_VIDEO_SAMPLEFMT_YUV422P = 4,
	ENUM_AVCODEC_VIDEO_SAMPLEFMT_YUV444P = 5,
	ENUM_AVCODEC_VIDEO_SAMPLEFMT_YUV410P = 6,
	ENUM_AVCODEC_VIDEO_SAMPLEFMT_YUV411P = 7,
