...
//                       媒体解析错误表
//////////////////////////////////////////////////////////////////////////
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_NALU_PARAMENT 0x80C2001       //参数错误
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_NALU_NOTFOUND 0x80C2002       //没有找到NALU单元,可能不是264格式
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_GETSPSPPS_PARAMENT 0x80C2010  //参数错误
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_GETSPSPPS_NOTPPS 0x80C2011    //没有找到PPS
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_GETSPSPPS_NOTSPS 0x80C2012    //没有找到SPS
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_GET265HDR_PARAMENT 0x80C2020  //参数错误
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_GET265HDR_NOTVPS 0x80C2021    //没有VPS信息
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_GET265HDR_NOTPPS 0x80C2022    //没有PPS信息
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_GET265HDR_NOTSPS 0x80C2023    //没有SPS信息
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_GETAAC_PARAMENT 0x80C2030     //获取音频信息失败,参数错误
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_GETAAC_NOTAAC 0x80C2031       //没有找到AAC头信息
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_GETAAC_PROFILE 0x80C2032      //获取属性级别失败
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_GETAAC_SAMPLE 0x80C2033       //获取采样率失败
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_PARAMENT 0x80C2050            //参数错误
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_INIT 0x80C2051                //初始化解析器失败
#define ERROR_XENGINE_AVCODEC_AVHELP_PARSE_NOTFIND 0x80C2052             //查找编码器失败
