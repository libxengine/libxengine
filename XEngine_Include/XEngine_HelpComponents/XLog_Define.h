...
#define NETENGINE_HELPCOMPONENTS_XLOG_IN_LOGLEVEL_ALL    0x00000000    //所有日志都打印
#define NETENGINE_HELPCOMPONENTS_XLOG_IN_LOGLEVEL_ALERT  0x00000001    //系统必须采取措施
#define NETENGINE_HELPCOMPONENTS_XLOG_IN_LOGLEVEL_CRIT   0x00000002    //系统已经达到临界值
#define NETENGINE_HELPCOMPONENTS_XLOG_IN_LOGLEVEL_ERROR  0x00000004    //错误级别日志
#define NETENGINE_HELPCOMPONENTS_XLOG_IN_LOGLEVEL_WARN   0x00000008    //警告级别日志
#define NETENGINE_HELPCOMPONENTS_XLOG_IN_LOGLEVEL_NOTICE 0x00000010    //正常但重要的条件
#define NETENGINE_HELPCOMPONENTS_XLOG_IN_LOGLEVEL_INFO   0x00000020    //常规信息
#define NETENGINE_HELPCOMPONENTS_XLOG_IN_LOGLEVEL_DEBUG  0x00000040    //调试信息
#define NETENGINE_HELPCOMPONENTS_XLOG_IN_LOGLEVEL_FATAL  0x00000080    //失败日志 SYSLOG不支持
#define NETENGINE_HELPCOMPONENTS_XLOG_IN_LOGLEVEL_OFF    1000          //全部关闭 SYSLOG不支持
//日志颜色设置
#define NETENGINE_HELPCOMPONENTS_XLOG_COLOR_CLEAR 0                    //清楚所有样式
#define NETENGINE_HELPCOMPONENTS_XLOG_TEXT_BLUE 0x0001                 //文本为蓝色
#define NETENGINE_HELPCOMPONENTS_XLOG_TEXT_GREEN 0x0002                //文本为绿色
#define NETENGINE_HELPCOMPONENTS_XLOG_TEXT_RED 0x0004                  //文本为红色
#define NETENGINE_HELPCOMPONENTS_XLOG_BACK_BLUE 0x0010                 //背景为蓝色
#define NETENGINE_HELPCOMPONENTS_XLOG_BACK_GREEN 0x0020                //背景为绿色
#define NETENGINE_HELPCOMPONENTS_XLOG_BACK_RED 0x0040                  //背景为红色
//////////////////////////////////////////////////////////////////////////
//日志输出类型
