...
*********************************************************************/
extern "C" XBOOL HelpComponents_Datas_CreateEx(XHANDLE xhNet, LPCXSTR lpszClientAddr, int nPoolIndex = -1);
/************************************************************************
...
************************************************************************/
extern "C" XBOOL HelpComponents_Datas_PostEx(XHANDLE xhNet,LPCXSTR lpszClientAddr,LPCXSTR lpszPostMsg,int nMsgLen);
/************************************************************************
...
备注：
************************************************************************/
extern "C" XBOOL HelpComponents_Datas_ClearEx(XHANDLE xhNet,LPCXSTR lpszClientAddr);
/************************************************************************
...
备注：
************************************************************************/
extern "C" XBOOL HelpComponents_Datas_DeleteEx(XHANDLE xhNet,LPCXSTR lpszClientAddr);
/************************************************************************
...
备注：
************************************************************************/
extern "C" XBOOL HelpComponents_Datas_WaitEventEx(XHANDLE xhNet, int nPoolIndex = -1, int nTimeOut = -1);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL HelpComponents_Datas_ActiveEventEx(XHANDLE xhNet, int nPoolIndex = -1);
/************************************************************************
...
*********************************************************************/
extern "C" XBOOL HelpComponents_Datas_GetPoolEx(XHANDLE xhNet, int nPoolIndex, HELPCOMPONENT_PACKET_CLIENT * **pppSt_ListClient, int* pInt_ListCount);
/************************************************************************
...
************************************************************************/
extern "C" XBOOL HelpComponents_Datas_GetSingleEx(XHANDLE xhNet, XCHAR *ptszClientAddr, XCHAR *ptszPacket, int *pInt_Len, XENGINE_PROTOCOLHDR *pSt_ProtocolHdr = NULL);
/************************************************************************
...
************************************************************************/
extern "C" XBOOL HelpComponents_Datas_AddPriorityEx(XHANDLE xhNet, ENUM_XXENGINE_XCOMM_PROTOCOL enXCommProto, ENUM_HELPCOMPONENTS_PACKET_PRIORITY enPacket_Priority);
/************************************************************************
...
备注：
************************************************************************/
extern "C" XBOOL HelpComponents_Datas_DelPriorityEx(XHANDLE xhNet, ENUM_XXENGINE_XCOMM_PROTOCOL enXCommProto);
/*************************************************************************
                        扩展组包导出函数
**************************************************************************/
/************************************************************************
...
extern "C" XBOOL HelpComponents_Packets_DeleteEx(XHANDLE xhNet, XSOCKET hSocket);
/************************************************************************
...
extern "C" XBOOL HelpComponents_Packets_AddPriorityEx(XHANDLE xhNet, ENUM_XXENGINE_XCOMM_PROTOCOL enXCommProto, ENUM_HELPCOMPONENTS_PACKET_PRIORITY enPacket_Priority);
extern "C" XBOOL HelpComponents_Packets_DelPriorityEx(XHANDLE xhNet, ENUM_XXENGINE_XCOMM_PROTOCOL enXCommProto);
extern "C" XBOOL HelpComponents_Packets_WaitEventEx(XHANDLE xhNet, int nPoolIndex = -1, int nTimeOut = -1);
extern "C" XBOOL HelpComponents_Packets_ActiveEventEx(XHANDLE xhNet, int nPoolIndex = -1);
/*************************************************************************
                        帮助层导出函数
**************************************************************************/
/************************************************************************
...
************************************************************************/
extern "C" XBOOL HelpComponents_Help_BuildPacket(XCHAR *ptszBuffer,int *pInt_Len,XENGINE_PROTOCOLHDR *pSt_ProtocolHdr,LPCXSTR lpszBuffer = NULL,int nLen = 0);
/************************************************************************
...
************************************************************************/
extern "C" XBOOL HelpComponents_Help_BuildPacketEx(XCHAR *ptszBuffer,int *pInt_Len,XENGINE_PROTOCOLHDREX *pSt_ProtocolHdr,LPCXSTR lpszBuffer = NULL,int nLen = 0);
/************************************************************************
...
备注：
************************************************************************/
extern "C" XBOOL HelpComponents_Help_ReWriteHdr(XCHAR *ptszPacket,XENGINE_PROTOCOLHDR *pSt_PacketHdr);
/************************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL HelpComponents_PKTCustom_SetTailEx(XHANDLE xhToken, int nTailSize);
/********************************************************************
...
备注：请注意ID非常重要，如果ID不同那么组包是不起作用的，ID需要你自己分配
*********************************************************************/
extern "C" XBOOL HelpComponents_PKTCustom_CreateEx(XHANDLE xhToken, XSOCKET hSocket, int nPoolIndex = -1);
/************************************************************************
...
备注：
************************************************************************/
extern "C" XBOOL HelpComponents_PKTCustom_PostEx(XHANDLE xhToken, XSOCKET hSocket, LPCXSTR lpszPostMsg, int nMsgLen);
/************************************************************************
...
备注：
************************************************************************/
extern "C" XBOOL HelpComponents_PKTCustom_ClearEx(XHANDLE xhToken, XSOCKET hSocket);
/************************************************************************
...
备注：
************************************************************************/
extern "C" XBOOL HelpComponents_PKTCustom_DeleteEx(XHANDLE xhToken, XSOCKET hSocket);
/************************************************************************
...
备注：参数二必须配合基础库的BaseLib_OperatorMemory_Free函数进行内存释放
*********************************************************************/
extern "C" XBOOL HelpComponents_PKTCustom_GetPoolEx(XHANDLE xhToken, int nPoolIndex, HELPCOMPONENT_PACKET_CLIENT * **pppSt_ListClient, int* pInt_ListCount);
/************************************************************************
...
备注：
************************************************************************/
extern "C" XBOOL HelpComponents_PKTCustom_WaitEventEx(XHANDLE xhToken, int nPoolIndex = -1, int nTimeOut = -1);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL HelpComponents_PKTCustom_ActiveEventEx(XHANDLE xhToken, int nPoolIndex = -1);
/*************************************************************************
                        缓存队列导出函数
**************************************************************************/
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL HelpComponents_Cache_DestoryEx(XHANDLE xhToken);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL HelpComponents_Cache_PostEx(XHANDLE xhToken, LPCXSTR lpszMsgBuffer, int nMsgLen);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL HelpComponents_Cache_WaitEventEx(XHANDLE xhToken, int nTimeOut = -1);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL HelpComponents_Cache_ActiveEventEx(XHANDLE xhToken);