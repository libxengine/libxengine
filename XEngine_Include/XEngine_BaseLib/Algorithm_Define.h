...
备注：
*********************************************************************/
extern "C" XBOOL Algorithm_String_GetMemoryInt(LPCXSTR lpszMsgBuffer, int nStart, int nEnd, int* pInt_Value);
/********************************************************************
...
备注：支持字符串和二进制快速匹配
*********************************************************************/
extern "C" XBOOL Algorithm_String_XFastMatch(LPCXSTR lpszSourceStr, LPCXSTR lpszFindStr, int *pInt_Pos, int nSourceLen = 0);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL Algorithm_FSort_DoubleSort(int *pInt_ArrayNumber, int nCount);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL Algorithm_FSort_QSort(XPVOID lPBase, int nNumber, int nSize);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL Algorithm_FSort_InsertSort(int *pInt_Array, int nValue);
/************************************************************************/
/*                     数学类算法导出函数                               */
/************************************************************************/
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL Algorithm_Math_Swap(XPVOID lPSource, XPVOID lPDest, LPCXSTR lpszType = _T("int"));
/********************************************************************
...
备注：支持正负数
*********************************************************************/
extern "C" XBOOL Algorithm_Math_GetValue(__int64x nValue, __int64x *pInt_Bits, int* pInt_Count);
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL Algorithm_Math_GetBit(XPVOID lParam, int nBits, XPVOID lPBits, int nSize = 4);
/********************************************************************
...
备注：145 = 10010001,从右到左数0 1 2 3
*********************************************************************/
extern "C" XBOOL Algorithm_Math_SetBit(XPVOID lParam, int nBits, int nSet = 1, int nSize = 4);
/************************************************************************/
/*                     计算类导出函数                                   */
/************************************************************************/
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL Algorithm_Calculation_Close(XHANDLE pxhToken);
/********************************************************************
...
*********************************************************************/
extern "C" XBOOL Algorithm_Calculation_SetTime(XHANDLE pxhToken);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL Algorithm_Calculation_ADDRVFlow(XHANDLE pxhToken, int nFlow);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL Algorithm_Calculation_ADDSDFlow(XHANDLE pxhToken, int nFlow);
/********************************************************************
...
备注：休眠函数使用微妙作为精度
*********************************************************************/
extern "C" XBOOL Algorithm_Calculation_SleepFlow(XHANDLE pxhToken, __int64u * pInt_WaitTime, __int64x nLimitCount, __int64x nUserCount, __int64x nSendCount);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL Algorithm_Calculation_PassiveOPen(XHANDLE pxhToken, CALLBACK_XENGINE_BASELIB_ALGORITHM_PASSIVE fpCall_CBPassive, int nAvgSDFlow = 0, int nAvgRVFlow = 0, int nAvgTime = 0, XPVOID lParam = NULL);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" XBOOL Algorithm_Calculation_PassiveClose(XHANDLE pxhToken);