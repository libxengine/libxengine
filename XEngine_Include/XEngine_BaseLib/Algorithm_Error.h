...
/*                     计算类型导出错误表                               */
/************************************************************************/
#define ERROR_XENGINE_LIB_ALGORITHM_CALCULATION_MALLOC 0x80A4001          //申请内存失败
#define ERROR_XENGINE_LIB_ALGORITHM_CALCULATION_PARAMENT 0x80A4002        //参数错误,关闭失败
#define ERROR_XENGINE_LIB_ALGORITHM_CALCULATION_THREAD 0x80A4003          //线程创建错误