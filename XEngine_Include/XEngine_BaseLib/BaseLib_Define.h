...
typedef void(XCALLBACK* CALLBACK_XENGINE_LIB_BASELIB_TIME_TRIGGER)(int nIDEvent, LPCXSTR lpszTimeStr, __int64x nTimeOffset, int nTTNumber, XPVOID lParam);
//////////////////////////////////////////////////////////////////////////////////
//                         导出的类型定义
//////////////////////////////////////////////////////////////////////////////////
//时间类型
...
*********************************************************************/
extern "C" bool BaseLib_Memory_Malloc(XVOID * **pppszPoint, size_t nCount, size_t nSize);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" bool BaseLib_Memory_Free(XVOID * **pppszPoint, size_t nCount);
/********************************************************************
...
备注：
*********************************************************************/
extern "C" bool BaseLib_Memory_FreeCStyle(XVOID** ppszPoint);
/********************************************************************
函数名称：BaseLib_Memory_MSGMalloc
函数功能：申请MSG结构数组内存
 参数.一：pSt_MSGBuffer
  In/Out：In
  类型：数据结构指针
...
返回值
  类型：逻辑型
  意思：是否成功
备注：pSt_MSGBuffer->nMSGLen[]需要填充好每个元素的大小,系统会自动初始化并且申请内存,不使用的元素大小设置为0即可
      申请的内存需要使用BaseLib_Memory_MSGFree函数进行释放
*********************************************************************/
extern "C" bool BaseLib_Memory_MSGMalloc(XENGINE_MSGBUFFER* pSt_MSGBuffer);
/********************************************************************
函数名称：BaseLib_Memory_MSGFree
函数功能：释放缓冲区内存数据
 参数.一：pSt_MSGBuffer
  In/Out：In
  类型：数据结构指针
...
备注：
*********************************************************************/
extern "C" bool BaseLib_Memory_MSGFree(XENGINE_MSGBUFFER* pSt_MSGBuffer);
/************************************************************************/
/*                         版本号操作                                   */
/************************************************************************/
/********************************************************************
