...
#define ERROR_XENGINE_LIB_BASELIB_OPERTATORSTRING_CHANGE_MALLOC 0x80B2083           //申请内存失败
...
#define ERROR_XENGINE_LIB_BASELIB_OPERTATORSTRING_GETSE_MALLOC 0x80B20A5            //申请内存失败
