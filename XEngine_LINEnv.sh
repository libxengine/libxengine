...
m_EnvAuthBreak=0
m_EnvRelease=0
m_EnvRunRPM='git redhat-lsb libuuid libpcap openssl-libs libcurl mariadb-connector-c zlib minizip ffmpeg-libs lksctp-tools bluez-libs lirc-libs SDL2 mongo-c-driver-libs libpq libsqlite3x rb_libtorrent'
m_EnvRunApt='git lsb-core lsb-release libuuid1 libpcap0.8 libssl1.1 libcurl4 libmysqlclient21 zlib1g libminizip1 libsctp1 libbluetooth3 liblircclient0 libsdl2-2.0-0 libbson-1.0-0 libmongoc-1.0-0 libpq5 libsqlite3-0 libavcodec58 libavdevice58 libavfilter7 libavformat58 libpostproc55 libswresample3 libswscale5 libtorrent-rasterbar9'
...
function InstallEnv_Print()
{
	...
	echo -e "\033[33m                       脚本版本：Ver 7.21.0.1001                              \033[0m"
	echo -e "\033[32m|***************************************************************************|\033[0m"
