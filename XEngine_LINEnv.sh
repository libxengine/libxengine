...
m_EnvMAC='curl openssl@3 sqlite zlib minizip mongo-c-driver mysql-client libpq libtorrent-rasterbar libnghttp2 ffmpeg@5'
...
function InstallEnv_Print()
{
	...
	echo -e "\033[33m                       脚本版本：Ver 8.0.0.1001                              \033[0m"
